...
public class SolutionChecker {
    ...
    private final CommandSequence[] sequences = {
            cs("Мой тест",
                    ex("45L - -15 + 011 + 0b01101 - 10", "72"), ex("* 10.5 + 20e-1", "758"),ex("0xFF__Fp4 - 0xC_e_C2", "12590") ),
            ...
            cs("Бинарные литералы",
                    ...
                    ex("0b1111111_11111111_11111111_11111111_11111111_11111111_11111111_11111111L + 2", "9223372036854776000")),
            ...
            cs("Дополнительно: поддержка всех литералов для вещественных типов",
                    ex("23.404 + 1.34e-4", "23.40"), ex("/ -3.4f", "-6.88"), ex("+ +0xCAFE__BABEp-2", "8.51"),
                    ex("- -0xDEADBEEF", "2.92")),
