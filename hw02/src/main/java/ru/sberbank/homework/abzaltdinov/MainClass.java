...
public class MainClass {
    public static void main(String[] args) {
        ...
        System.out.println(Parser.parseNumber(".1"));
        System.out.println(Parser.parseNumber("01234"));
        ...
        System.out.println(Parser.parseNumber("1101l"));
        System.out.println(Parser.parseNumber("0b1111"));
